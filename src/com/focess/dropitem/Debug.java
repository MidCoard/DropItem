...
public class Debug {
	...
	static {
		...
		Debug.ownerClass.add(RemoveDropItemListener.class.getName());
		Debug.ownerClass.add(SpawnDropItemListener.class.getName());
		Debug.ownerClass.add(PlayerMoveListener.class.getName());
		Debug.ownerClass.add(DropItemRunnable.class.getName());
		Debug.ownerClass.add(AnxiCode.class.getName());
		Debug.ownerClass.add(DropItemInfo.class.getName());
		Debug.ownerClass.add(DropItemPermissionListener.class.getName());
